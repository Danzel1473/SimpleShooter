...
void AShooterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction(TEXT("Menu"), EInputEvent::IE_Pressed, this, &AShooterCharacter::Shoot);
...
float AShooterCharacter::GetHealthPersent() const
{
...
int AShooterCharacter::GetExtraAmmo() const
{
    return Gun->GetExtraAmmo();
}
